...
<head>
  ...
  <title>Espace - Access</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{asset('assets/assets/img/kks.jpg')}}" rel="icon">
  <link href="{{asset('assets/assets/img/kks.jpg')}}" rel="apple-touch-icon">
...
<body class="index-page">
 ...
 @include('demandeur.layouts.navbar')

  @yield('content')

  @include('demandeur.layouts.footer')
