...
<head>
    ...
    <title>Claimant - login</title>
    <style>
        :root {
            --primary-color: #193561;
            --secondary-color: #193561;
            --accent-color: #4895ef;
            --error-color: #f72585;
        ...
        * {
        ...
        body {
            ...
            margin: 0;
            background: 
                linear-gradient(rgba(0, 51, 196, 0.1), rgba(25,53,97, 0.9)),
...
<body>
    <form class="form-container animate__animated animate__fadeIn" method="POST" action="{{route('demandeur.handleLogin')}}">

        <div class="form-header">
           <img src="{{ asset('assets/assets/img/kks.jpg') }}" class="auth-logo floating" alt="Logo"><br>
