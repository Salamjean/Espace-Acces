    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="{{route('society.dashboard')}}" class="active">Accueil</a></li>
            <li><a href="{{route('society.pages.about')}}">A propos</a></li>
            <li><a href="{{route('society.pages.service')}}">Services</a></li>
            <li><a href="{{route('society.pages.contact')}}">Contact</a></li>
          </ul>
        ...
        <div class="header-buttons d-flex align-items-center gap-2">
          ...
          <a class="logout-btn d-none d-md-inline-flex" href="{{ route('society.logout') }}" 
          ...
          <div class="d-md-none mobile-buttons d-flex gap-2">
            ...
            <a class="logout-btn-mobile" href="{{ route('society.logout') }}" 
               onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
               title="Déconnexion">
        ...
        <form id="logout-form" action="{{ route('society.logout') }}" method="POST" style="display: none;">
            @csrf
        </form>
