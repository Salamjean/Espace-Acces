...
<head>
    ...
    <title>Personal - Sing up</title>
</head>

<style>
  :root {
    --primary-color: #193561;
    --primary-light: #193561;
    --primary-dark: #28a745;
    --light-color: #ffffff;
    --dark-color: #212529;
    --gray-color: #6c757d;
...
<div class="auth-container">
  <div class="auth-card animate__animated animate__fadeIn">
    <div class="auth-header">
      <img src="{{ asset('assets/assets/img/kks.jpg') }}" class="auth-logo floating" alt="Logo">
    ...
    <div class="auth-body">
      <form method="POST" action="{{ route('personal.validate', $email) }}">
        @csrf
        @method('post')
