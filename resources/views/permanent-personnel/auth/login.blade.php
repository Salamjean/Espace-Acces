    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            margin: 0;
            background: 
                linear-gradient(rgba(0, 51, 196, 0.1), rgba(25,53,97, 0.7)),
...
<body>
    <form class="form-container animate__animated animate__fadeIn" method="POST" action="{{route('personal.handleLogin')}}">
