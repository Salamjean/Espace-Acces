...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card" style="border: none; border-radius: 15px; background: linear-gradient(135deg, #193561 0%, #193561 100%);margin-top:10px">
                <div class="card-body py-4">
                    <div class="row align-items-center">
                        <div class="col-md-12" style="display: flex;justify-content:space-between">
                            <h4 class="mb-1 text-white">
                                <i class="bi bi-person-badge me-2"></i>Mes Visites
                            </h4>
                            <p class="mb-0 text-white opacity-75">Historique de mes entrées et sorties</p>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('personal.dashboard') }}" method="GET" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <button type="submit" class="btn  w-100" 
                                        style="border-radius: 8px; border: none; padding: 10px; background-color:#193561; color:white">
                                    <i class="bi bi-search me-1"></i>Filtrer
                                </button>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('personal.dashboard') }}" class="btn btn-outline-secondary w-100"
    ...
    <!-- Tableau des visites personnelles -->
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    <h6 class="mb-0"><i class="bi bi-list-ul me-2"></i>Mes Historiques de Visites</h6>
                    <div class="text-muted small">
                        {{ $visites->total() }} visite(s) trouvée(s)
                    </div>
                </div>
                    ...
                    @if($visites->count() > 0)
                            ...
                            <table class="table table-hover mb-0">
                                <thead style="background: #f8f9fa;">
                                    <tr class="text-center">
                                        ...
                                        <th class="border-0 text-center">Observations</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <small class="text-muted">{{ $visite->agent->name ?? 'N/A' }} {{ $visite->agent->prenom ?? '' }}</small>
                                        </td>
                                        <td style="text-align:center">
                                            <small class="text-muted">{{ $visite->observations ?? 'Aucune' }}</small>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="card-footer bg-light">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    {{ $visites->links('pagination.custom') }}
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('personal.dashboard') }}" class="btn " style="background-color:#193561; color:white">
