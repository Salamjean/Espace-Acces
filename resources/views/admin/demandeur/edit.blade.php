    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-title">
                <h1 class="page-title">
                    <i class="fas fa-user-edit icon-primary"></i>
                    Modifier le Demandeur
                </h1>
                <p class="page-subtitle">Modifiez les informations du demandeur ci-dessous</p>
            </div>
        ...
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <div class="form-header-text">
                    <h2>Modification du Demandeur</h2>
                    <p>Tous les champs marqués d'un * sont obligatoires</p>
                </div>
            </div>

            <!-- Formulaire -->
            <form id="demandeurForm" action="{{ route('demandeur.update', $demandeur->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('name') error @enderror" 
                                   id="name" name="name" value="{{ old('name', $demandeur->name) }}" 
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('prenom') error @enderror" 
                                   id="prenom" name="prenom" value="{{ old('prenom', $demandeur->prenom) }}" 
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="email" class="form-input @error('email') error @enderror" 
                                   id="email" name="email" value="{{ old('email', $demandeur->email) }}" 
                                   placeholder="jean.kouadio@example.com" readonly>
                            @error('email')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('contact') error @enderror" 
                                   id="contact" name="contact" value="{{ old('contact', $demandeur->contact) }}" 
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('structure') error @enderror" 
                                   id="structure" name="structure" value="{{ old('structure', $demandeur->structure) }}" 
                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('adresse') error @enderror" 
                                   id="adresse" name="adresse" value="{{ old('adresse', $demandeur->adresse) }}" 
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('fonction') error @enderror" 
                                   id="fonction" name="fonction" value="{{ old('fonction', $demandeur->fonction) }}" 
                        ...
                        <div class="input-group modern-input">
                            ...
                            <div class="current-photo-container">
                                <img src="{{ asset('storage/' . $demandeur->profile_picture) }}" 
                                     alt="Photo actuelle" class="current-photo" style="width: 20%">
                                <div class="current-photo-info">
                                    <span>Photo actuelle</span>
                                    <small>Conservée si aucune nouvelle photo n'est sélectionnée</small>
                                </div>
                            </div>
                        </div>
                        @endif
                                ...
                                <label for="profile_picture" class="file-upload-label">
                                    <div class="file-upload-content">
                                        ...
                                        <div class="upload-text">
                                            <span class="file-main-text">Cliquez pour changer la photo</span>
                        ...
                        <div class="image-preview-container" id="imagePreviewContainer">
                            <div class="preview-header">
                                <span>Aperçu de la nouvelle photo</span>
                ...
                <div class="info-card">
                    ...
                    <div class="info-content">
                        ...
                        <p>Seuls les informations de profil seront modifiées. Le mot de passe reste inchangé.</p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Soumission du formulaire - VERSION MODIFICATION
            ...
            .then(result => {
                if (result.type === 'json') {
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div class="success-content">
                                    ...
                                    <h3>Demandeur modifié avec succès!</h3>
                                    <p>Les informations de <strong>${document.getElementById('prenom').value} ${document.getElementById('name').value}</strong> ont été mises à jour.</p>
                                </div>
                            `,
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Succès!',
                        text: 'Demandeur modifié avec succès!',
                        confirmButtonColor: '#1c3966',
