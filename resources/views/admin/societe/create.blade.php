...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-title">
                ...
                <p class="page-subtitle">Remplissez les informations ci-dessous pour créer un nouveau compte société</p>
            </div>
            <a href="{{ route('society.index') }}" class="back-btn">
    ...
    <div class="form-container">
        <div class="form-card">
            ...
            <!-- Formulaire -->
            <form id="societeForm" action="{{ route('society.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('name') error @enderror" 
                                   ...
                                   placeholder="Ex: Entreprise XYZ SARL" required>
                            @error('name')
                    ...
                    <div class="form-column">
                        ...
                        <div class="input-group modern-input">
                            ...
                            <input type="text" class="form-input @error('adresse') error @enderror" 
                                   ...
                                   placeholder="123 rue galarie des parcs, 75008 Plateau">
                            @error('adresse')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-content">
                        ...
                        <p>Un mail sera envoyé à la société pour qu'elle puisse definir ses accès elle pour faire sa demande.</p>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (societeForm) {
        societeForm.addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            fetch(this.action, {
                ...
                headers: {
                    ...
                    'Accept': 'application/json, text/html' // Accepter HTML et JSON
                }
            })
            .then(response => {
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div class="success-content">
                                    ...
                                    <h3>Société créée avec succès!</h3>
                                    <p>Un email de confirmation a été envoyé à <strong>${document.getElementById('email').value}</strong></p>
                                </div>
                            `,
                            confirmButtonColor: '#1c3966',
                            confirmButtonText: 'Voir la liste des sociétés'
                        }).then(() => {
                            window.location.href = result.data.redirect || "{{ route('society.index') }}";
                        });
                    } else {
                        throw new Error(result.data.message || 'Une erreur est survenue');
                    }
                } else {
                    // Traitement des redirections HTML
                    // Si on reçoit du HTML, c'est probablement une redirection
                    // On simule le comportement de redirection
                    Swal.fire({
                        icon: 'success',
                        title: 'Succès!',
