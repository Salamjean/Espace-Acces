            ...
            <div class="card" style="border: none; border-radius: 10px; background: #193561;">
                <div class="card-body py-3">
                    <h4 class="mb-0 text-white">
                        <i class="bi bi-person-gear me-2"></i>Modifier l'Agent
                    </h4>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm" style="border: none; border-radius: 15px;">
                <div class="card-header py-3" style="background: #193561; border-radius: 15px 15px 0 0;">
                    <h5 class="mb-0 text-white text-center">
                        <i class="bi bi-person-shield me-2"></i>Modification d'un Agent - Formulaire en Étapes
                    </h5>
                </div>
                ...
                <div class="card-body p-4" style="background-color: #e9eaef">
                    ...
                    <form action="{{ route('agent.update', $agent->id) }}" method="POST" enctype="multipart/form-data" id="agentForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control" id="commune" name="commune" required 
                                        ...
                                        <option value="Abobo" {{ old('commune', $agent->commune) == 'Abobo' ? 'selected' : '' }}>Abobo</option>
                                        <option value="Adjamé" {{ old('commune', $agent->commune) == 'Adjamé' ? 'selected' : '' }}>Adjamé</option>
                                        <option value="Attécoubé" {{ old('commune', $agent->commune) == 'Attécoubé' ? 'selected' : '' }}>Attécoubé</option>
                                        <option value="Cocody" {{ old('commune', $agent->commune) == 'Cocody' ? 'selected' : '' }}>Cocody</option>
                                        <option value="Koumassi" {{ old('commune', $agent->commune) == 'Koumassi' ? 'selected' : '' }}>Koumassi</option>
                                        <option value="Marcory" {{ old('commune', $agent->commune) == 'Marcory' ? 'selected' : '' }}>Marcory</option>
                                        <option value="Plateau" {{ old('commune', $agent->commune) == 'Plateau' ? 'selected' : '' }}>Plateau</option>
                                        <option value="Port-Bouët" {{ old('commune', $agent->commune) == 'Port-Bouët' ? 'selected' : '' }}>Port-Bouët</option>
                                        <option value="Treichville" {{ old('commune', $agent->commune) == 'Treichville' ? 'selected' : '' }}>Treichville</option>
                                        <option value="Yopougon" {{ old('commune', $agent->commune) == 'Yopougon' ? 'selected' : '' }}>Yopougon</option>
                                    </select>
                                    @error('commune')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cas_urgence" name="cas_urgence" 
                                           value="{{ old('cas_urgence', $agent->cas_urgence) }}" 
                                           style="border: 2px solid #193561; border-radius: 8px; padding: 12px;">
                                    @error('cas_urgence')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="step-content d-none" id="step3">
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold" style="color: #193561;">
                                    <i class="bi bi-image me-1"></i>Photo actuelle
                                </label>
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $agent->profile_picture) }}" 
                                         alt="Photo actuelle" 
                                         style="max-width: 200px; max-height: 200px; border: 2px solid #193561; border-radius: 10px;">
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="mb-4">
                                <label for="profile_picture" class="form-label fw-bold" style="color: #193561;">
                                    <i class="bi bi-camera me-1"></i>Nouvelle photo de profil
                                </label>
                                <input type="file" class="form-control" id="profile_picture" name="profile_picture" 
                                       accept="image/jpeg,image/png,image/jpg,image/gif" 
                                       style="border: 2px solid #193561; border-radius: 8px;">
                                <div class="form-text" style="color: #193561;">
                                    Formats acceptés : JPEG, PNG, JPG, GIF (max 2MB). Laissez vide pour conserver l'actuelle.
                                </div>
                            ...
                            <div class="mb-4 text-center">
                                <div id="imagePreview" class="d-none">
                                    <img id="preview" src="#" alt="Aperçu de la nouvelle image" 
                            ...
                            <div class="card mb-4" style="border: 2px solid #193561; border-radius: 10px;">
                                <div class="card-header" style="background: #193561; color: white;">
                                    <h6 class="mb-0"><i class="bi bi-list-check me-2"></i>Récapitulatif des modifications</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6 text-end">
                                    <button type="submit" class="btn btn-warning" 
                                            style="background: #ffc107; border: none; border-radius: 8px; padding: 10px 30px; font-weight: bold; color: #000;">
                                        <i class="bi bi-check-lg me-2"></i>Modifier l'Agent
                                    </button>
                                </div>
                            </div>
                        </div>
...
.btn-next:hover, .btn-warning:hover {
