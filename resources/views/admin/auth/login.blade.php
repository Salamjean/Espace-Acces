    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            margin: 0;
            background: 
                linear-gradient(rgba(238, 206, 0, 0.1), rgba(25,119,204, 0.975)),
...
<body>
    <form class="form-container animate__animated animate__fadeIn" method="POST" action="{{ route('admin.handleLogin') }}">
        <div class="form-header">
           <img src="{{ asset('assets/assets/img/kks.jpg') }}" class="auth-logo floating" alt="Logo" style="height:80px"><br>
