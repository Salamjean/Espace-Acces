...
class SendEmailToPersonalAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Espace - Accès: Personnel enregistré avec succès') // Sujet mis à jour
            ->from('contact@edemarchee-ci.com', 'Espace - Accès')
            ->view('emails.personal_registration', [
                'code' => $this->code,
                'email' => $this->email,
